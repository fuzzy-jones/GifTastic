...
var characters = ["Jon Snow", "The Mountain", "Tyrion Lannister", "Bran Stark", "Cersei Lannister", "Ice King", "Hodor", "Arya Stark"]

function displayCharacterInfo() {
    
    var characters = $(this).attr();
    var queryURL = "https://api.giphy.com/v1/gifs/search?=" + characters + "xFHtqYPE42jbIneYyI0aPoygDEg0EZwA&q=&limit=10&offset=0&rating=G&lang=en";
